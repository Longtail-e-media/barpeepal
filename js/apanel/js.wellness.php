...
function getLocation(){
	return '<?php echo BASE_URL;?>includes/controllers/ajax.wellness.php';
}
function getTableId(){
	return 'table_dnd';
}
...
$(document).ready(function() {
	oTable = $('#example').dataTable({
		...
		"sPaginationType": "full_numbers"
		  ...
		  sURL:"<?php echo BASE_URL;?>includes/controllers/ajax.wellness.php?action=sort",
				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>wellness/list";},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>wellness/addEdit";},3000);						   	
						   if(actionId==0)
...
function recordDelete(Re){
	$('.MsgTitle').html('<?php echo sprintf($GLOBALS['basic']['deleteRecord_'],"wellness")?>');															
	$('.pText').html('Click on yes button to delete this wellness permanently.!!');
...
{
	window.location.href="<?php echo ADMIN_URL?>wellness/list";
}

/***************************************** Add New wellness *******************************************/
function AddNewwellness()
{
	window.location.href="<?php echo ADMIN_URL?>wellness/addEdit";
}

/***************************************** Edit records *****************************************/
function editRecord(Re)
{
	window.location.href="<?php echo ADMIN_URL?>wellness/addEdit/"+Re;
}
