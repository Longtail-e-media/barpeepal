...
<?php
$moduleTablename = "tbl_wellness"; // Database table name
$moduleId = 311;                // module id >>>>> tbl_modules
$moduleFoldername = "wellness";        // Image folder name

if (isset($_GET['page']) && $_GET['page'] == "wellness" && isset($_GET['mode']) && $_GET['mode'] == "list"):
    ...
    <div class="example-box">
        <div class="example-code">
            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                ...
                <tbody>
                <?php $records = wellness::find_by_sql("SELECT * FROM " . $moduleTablename . " ORDER BY sortorder DESC ");
...
<?php elseif (isset($_GET['mode']) && $_GET['mode'] == "addEdit"):
    if (isset($_GET['id']) && !empty($_GET['id'])):
        ...
        $articlesInfo =wellness::find_by_id($articlesId);
    ...
    ?>
    <h3>
        <?php echo (isset($_GET['id'])) ? 'Edit Wellness' : 'Add Wellness'; ?>
        <a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);"
                    ...
                    if (!empty($articlesInfo->image)) {
                        ...
                        if (is_array($imgRec)) {
                            foreach ($imgRec as $key => $recimg) {
                                ...
                                $imagePath = SITE_ROOT . 'images/wellness/' . $recimg;
                            ...
                            <span class="float-left">
                                <?php
                                if (file_exists(SITE_ROOT . "images/wellness/" . $recimg)):
                                    $filesize = filesize(SITE_ROOT . "images/wellness/" . $recimg);
                                ...
                                ?>
                                            ...
                                            <img src="<?php echo IMAGE_PATH . 'wellness/thumbnails/' . $recimg; ?>"
                                                 style="width:100%"/>
        ...
        $(document).ready(function () {
            $('#gallery_upload').uploadify({
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/wellness/uploaded_image.php', {imagefile: filename}, function (msg) {
