...
if($booking_type==1) {
    ...
    <a href="'.BASE_URL.'/reservation" class="book_now_btn" target="_blank" rel="noopener noreferrer"><button type="submit" class="btn btn-huge">
            Book Now
        </button></a>
    </div>';

    // Bottom link
    $resbtnlink.='<a class="book_now_btn" href="'.BASE_URL.'reservation" target="_blank" rel="noopener noreferrer">Reserve now</a>';  
}

// Nepalhotel
if($booking_type==2) {
    $resbking.='<!--================ Layer ================-->
        <div class="check-availability-two bg-transparent homepage_box_right">
            <form action="result.php" target="_blank" rel="noopener noreferrer" method="get">
                <input type="hidden" name="hotel_code" value="'. $booking_code .'">
                <ul>
                    <li>
                        <h5>Check In</h5>
                        <input type="text" placeholder="Select a date" class="datepicker bg-transparent" name="hotel_check_in" id="checkin"> <i class="far fa-calendar-alt"></i>
                    </li>
                    <li>
                        <h5>Check Out</h5>
                        <input type="text" placeholder="Select a date" class="datepicker bg-transparent" name="hotel_check_out" id="checkout"> <i class="far fa-calendar-alt"></i>
                    </li>
                </ul>
...
<!--================ End of Layer ================--> 
    ...
    // Bottom link
    $resbtnlink.='<a href="http://www.fastbookings.biz/DIRECTORY/'.$booking_page.'?s=results&Clusternames='.$booking_code.'&Hotelnames='.$booking_code.'" class="btn btn-medium btn-darkbrown" target="_blank" rel="noopener noreferrer">Book now</a>';
}
