...
$jVars['site:copyright']	= '<div class="text">'.str_replace('{year}',date('Y'),$siteRegulars->copyright).' Developed by <a href="https://longtail.info/" target="_blank" rel="noopener noreferrer" class="text-white">Longtail e-media</a></div>';
