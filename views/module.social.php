...
if(!empty($icon)){
    $disicon='<a href="' . $socialRow->linksrc . '" target="_blank" rel="noopener noreferrer" ><img src="'.IMAGE_PATH.'social/' . $socialRow->image . '"/alt="icon"></a>';
}
else{
    $disicon='<a href="' . $socialRow->linksrc . '" target="_blank" rel="noopener noreferrer" ><i class="' . $socialRow->icon . '"></i></a>';
}
...
if (!empty($socialRec)) {
    foreach ($socialRec as $socialRow) {
        $ressl .= ' <a href="' . $socialRow->linksrc . '" target="_blank" rel="noopener noreferrer" ><i class="fa ' . $socialRow->image . '"></i></a>';
    }
}
...
if (!empty($otaRec)) {
    foreach ($otaRec as $otaRow) {
        $ota .= '<div class="ota-child"><a href="' . $otaRow->linksrc . '" target="_blank" rel="noopener noreferrer" ><img src="' . IMAGE_PATH . 'social/' . $otaRow->image . '" alt="'.$otaRow->title.'"></a></div>';
    }
}
